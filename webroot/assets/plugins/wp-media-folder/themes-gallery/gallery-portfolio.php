...
foreach ($attachments as $id => $attachment) {
    ...
    if ($customlink) {
        ...
        if (strpos($image_output, "data-lightbox='0'")) {
            ...
            $icon = "<a data-lightbox='1' href='$url_image' title='$post_title' class='hover_img $tclass'></a><a data-lightbox='1' class='portfolio_lightbox $tclass' href='$url_image' title='$post_title'>+</a>";
        }
