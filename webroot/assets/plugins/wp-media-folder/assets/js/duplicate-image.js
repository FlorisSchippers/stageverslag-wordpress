(function ($) {
    ...
    $(document).ready(function () {
        ...
        var form_uplicate = '<div class="wpmf_wrap_duplicate"><input type="submit" value="'+ wpmflang.duplicate_text +'" class="button-primary wpmf_btn_duplicate"/><span class="spinner wpmf_spinner_duplicate"></span><p class="wpmf_message_duplicate"></p></div>';
            ...
            createSingle: function() {
                ...
                if (wpmflang.wpmf_pagenow != 'upload.php') {
                    if (typeof wpmflang.duplicate != 'undefined' && wpmflang.duplicate == 1) {
                        $(sidebar.$el).find('.attachment-info').append(form_uplicate);
                    }
                }
            }
        });
